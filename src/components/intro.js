...
function Intro() {
    return(
        <div 
            className="pt-[110px] lg:pt-[180px] text-center lg:text-left pl-[30px] md:pl-[50px] lg:pl-[80px]"  
        >
            <div 
                className="text-left sm:w-[450px] inline-block align-middle xl:w-[550px] "
                data-aos="fade-right"
            ...
            <div 
                className="text-left inline-block align-middle pt-[40px] lg:pt-0 md:px-[50px] xl:pl-[150px]"
                data-aos="fade-left"
                data-aos-delay="500"
                data-aos-duration="2000"  
            >
